...
export const TRANSACTIONS = [
  { id: 't1', name: 'Maria Garcia', handle: '$mariagarcia', amount: 50, note: 'Dinner split', date: 'Today', pending: false, seed: 'maria-lp', bg: 'ede9fe' },
  { id: 't2', name: 'Jordan Lee', handle: '$jordanlee', amount: -20, note: 'Coffee', date: 'Today', pending: false, seed: 'jordan-lp', bg: 'fce7f3' },
  { id: 't3', name: 'Sam Rivera', handle: '$samrivera', amount: 120, note: 'Concert tickets', date: 'Yesterday', pending: false, seed: 'sam-lp', bg: 'dcfce7' },
  { id: 't4', name: 'Casey Brooks', handle: '$caseybrooks', amount: -15, note: 'Parking', date: 'Jun 20', pending: true, seed: 'casey-lp', bg: 'cffafe' },
  { id: 't5', name: 'Taylor Kim', handle: '$taylorkim', amount: -82.15, note: 'Groceries', date: 'Jun 19', pending: true, seed: 'taylor-lp', bg: 'ffedd5' },
  { id: 't6', name: 'Maria Garcia', handle: '$mariagarcia', amount: 35, note: 'Movie night', date: 'Jun 18', pending: false, seed: 'maria-lp', bg: 'ede9fe' },
  { id: 't7', name: 'Jordan Lee', handle: '$jordanlee', amount: -12, note: 'Lunch', date: 'Jun 17', pending: false, seed: 'jordan-lp', bg: 'fce7f3' },
]
