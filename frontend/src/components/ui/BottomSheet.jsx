...
/**
 * A bottom sheet: dimmed backdrop plus a card that slides up and back down on dismiss. `children` may
 * be a function receiving `{ close }`, and the panel is height-capped, so long content must scroll.
 * @param {object} props
