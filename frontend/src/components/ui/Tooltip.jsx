...
/** Wraps a subtree so its tooltips share hover/timing behavior. */
export const TooltipProvider =
  TooltipPrimitive.Provider;

/** Root component owning a single tooltip's open state. */
