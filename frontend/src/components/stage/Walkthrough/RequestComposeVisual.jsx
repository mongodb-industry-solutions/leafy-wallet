...
export function RequestComposeVisual() {
  return (
    <div className="flex h-full w-full items-center justify-center">
      <div className="w-56 rounded-2xl border border-border bg-white p-3.5 shadow-md">
        <div className="mb-2.5 flex items-center justify-between">
          <span className="text-[11px] font-bold text-foreground">Request money</span>
          <span className="flex items-center gap-1 rounded-full bg-card px-2 py-0.5 text-[9px] font-semibold text-muted-foreground">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center justify-between rounded-lg bg-card px-2.5 py-1.5">
