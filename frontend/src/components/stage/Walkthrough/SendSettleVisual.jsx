...
export function SendSettleVisual() {
  return (
    <div className="flex h-full w-full items-center justify-center">
      <div className="flex w-56 flex-col gap-2.5 rounded-2xl border border-border bg-white p-3.5 shadow-md">
        ...
        <div className="flex items-center gap-2.5 rounded-xl bg-card px-2.5 py-2">
          <span className="relative flex size-7 shrink-0 items-center justify-center rounded-full bg-white text-muted-foreground">
            <span
