  ...
  return (
    <VisualCard className="flex w-60 items-center justify-between px-4 py-5">
      ...
      <div className="relative size-10 shrink-0">
        <span
          className="absolute inset-0 flex items-center justify-center rounded-full bg-muted font-mono text-[11px] font-bold tracking-tight text-muted-foreground"
          style={{ animation: 'status-badge-pending 4.5s ease-in-out infinite' }}
        >
          ••••
        </span>
        {/* Resolves into the real contact avatar. */}
        <span className="absolute inset-0" style={{ animation: 'status-badge-done 4.5s ease-in-out infinite' }}>
      ...
      <div className="relative h-8 w-20 shrink-0">
        <span
          className="absolute inset-0 flex items-center rounded-lg bg-muted px-2 font-mono text-[11px] font-bold text-muted-foreground"
          style={{ animation: 'status-badge-pending 4.5s ease-in-out infinite' }}
        >
          ••••••
        </span>
