...
/**
 * The simulated pointer that drives the tour: moves to the director's `command` target, performs the
 * real interaction, then reports via `onStepComplete`. At stage scope so it can leave the phone.
 * @param {object} props
