...
/**
 * A row of dots that bounce in sequence, used as an inline "loading" indicator.
 * @param {object} props
 * @param {string} [props.className] - Extra classes for the wrapping span.
 * @param {number} [props.dots] - Number of dots to render.
 */
function BouncingDots({ className, dots = 3, ...props }) {
  return (
    <>
      <style>{`
